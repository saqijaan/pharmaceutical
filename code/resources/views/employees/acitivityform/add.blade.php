            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('clinical-activity-form.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                <div class="form-group">
                                    <label class="control-label col-md-3 col-sm-3 col-xs-12" for="form[a]"> Doctor Name <span class="required">*</span>
                                    </label>
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <input type="text" id="form[a]" required="required" name="form[a]" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[b]" required="required" name="form[b]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[c]" name="form[c]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[d]" name="form[d]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[e]" name="form[e]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[f]" name="form[f]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[g]" name="form[g]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[h]" name="form[h]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[i]" name="form[i]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[j]" name="form[j]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[k]" name="form[k]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[l]" name="form[l]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[m]" name="form[m]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[n]" name="form[n]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[o]" name="form[o]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="form[p]" name="form[p]" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
