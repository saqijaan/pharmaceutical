            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('quiz-regis.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                                ...
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $quizs as $quiz )
                                        <tr class="even pointer">
                                            ...
                                            <td class=" last">
                                                <a type="button" data-mdlid="{{ $quiz->id }}" class="btn btn-primary openBtn">
                                                    View
                                                </a>
...
@section('bottom_script')
    <script>
        $('.openBtn').on('click',function(){
            ...
            $('.modal-body').load('{{url("/dashboard/quiz-regis/view/")}}'+'/'+id,function(){
