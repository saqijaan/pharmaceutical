        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Update Purchase Return   </h2>
                             
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('purchase-return.update', [$purchaseMas->id] ) }}" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="item form-group col-md-12 col-sm-12 col-xs-12"><!-- textarea start -->
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        ...
                                        <textarea id="" class="ckeditor" name="detail" placeholder="Slider Detail">
                                            {{$purchaseMas->detail}}
                                        </textarea>
                                    </div>
                                </div><!-- textarea end -->
