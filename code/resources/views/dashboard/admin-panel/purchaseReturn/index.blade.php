            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('purchase-return.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                                    ...
                                    @foreach( $purchaseMas as $purchaseMa )
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" last">
                                                ...
                                                <a class="btn btn-primary" href="{{ route('purchase-return.edit', $purchaseMa->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('purchase-return.destroy',$purchaseMa->id)}}" style="display: inline">
...
@section('bottom_script')
    <script>
        $('.openBtn').on('click',function(){
            ...
            $('.modal-body').load('{{url("/dashboard/purchase-return/view/")}}'+'/'+id,function(){
