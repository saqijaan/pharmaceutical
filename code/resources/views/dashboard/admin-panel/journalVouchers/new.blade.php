            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('journal-vouchers.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12" id="items">
                                        <input type="text" id="acnt_nme" required="required" name="acnt_nme" class="form-control autocomplete-custom-append col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="acnt_nbr" required="required" name="acnt_nbr" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
