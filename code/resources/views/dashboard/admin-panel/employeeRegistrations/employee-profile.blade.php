        ...
        <div class="">
            ...
            <div class="row">
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> {{$employeeRegis->name}} <small> employee Designation </small></h2>
                             
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <div class="col-md-3 col-sm-3 col-xs-12 profile_left"><!-- profile detail start -->
                            ...
                            <div class="col-md-9 col-sm-9 col-xs-12">
                                ...
                                <!-- ===================== employee graph report start =========================== -->

                                <div class="profile_title">
                                    <div class="col-md-6">
                                        <h2> {{ $employeeRegis->name }} Activity Report</h2>
                                    </div>
                                    <div class="col-md-6">
                                ...
                                <!-- ===================== employee graph report end =========================== -->



                                <!-- ===================== employee activity report start =========================== -->
