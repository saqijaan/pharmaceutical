                        ...
                        <div class="x_content">
                            ...
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('purchase-master.store') }}" class="form-horizontal form-label-left">
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="number" id="supplier_invoice_no" name="supplier_invoice_no" value="{{ old('supplier_invoice_no',date('yymmddss')) }}"  maxlength="15" class="form-control" required>
                                    </div>
                                </div>
