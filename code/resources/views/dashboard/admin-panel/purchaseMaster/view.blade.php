...
<div class="container" id="masterContent">
    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <p style="border: 1px solid #ccc;padding: 5px 5px;"> {{ $purchaseMas->discount }}</p>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12">
        ...
        <div class="col-md-12 col-sm-12 col-xs-12">
            <h3 style="margin-bottom: 0;font-size: 14px;font-weight: bolder;"> Details </h3>
            <p style="border: 1px solid #ccc;padding: 5px 5px;"> {!! $purchaseMas->detail !!}</p>
        </div>
    </div>
    <a class="btn btn-success" href="{{action('PurchaseMasterController@downloadPDF', $purchaseMas->id)}}" target="_blank">Get PDF/Print </a>
</div>
