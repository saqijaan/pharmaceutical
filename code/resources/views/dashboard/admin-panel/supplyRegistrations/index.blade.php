            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('supply-registration.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $supRegis as $supRegi )

                                        <tr class="even pointer">
                                            <td class=" "> {{ $supRegi->id }}</td>
                                            <td class=" ">
                                                <img src="{{ asset('uploads/supplyRegister/s/'.$supRegi->image) }}" alt="" />
                                            </td>
                                            <td class=" "> {{ $supRegi->name }} </td>
                                            <td class=" "> {!! $supRegi->email !!} </td>
                                            <td class=" "> {!! $supRegi->mobile !!} </td>
                                            <td class=" last">
                                                <a class="btn btn-primary" href="{{route( 'supply-profile',$supRegi->id )}}">
                                                    View
                                                </a>
                                                <a class="btn btn-primary" href="{{ route('supply-registration.edit', $supRegi->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('supply-registration.destroy',$supRegi->id)}}" style="display: inline">
