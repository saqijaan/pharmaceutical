            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('transaction-registration.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $transRegis as $transRegi )

                                        <tr class="even pointer">
                                            <td class=" "> {{ $transRegi->id }}</td>
                                            <td class=" ">
                                                <img src="{{ asset('uploads/transRegister/s/'.$transRegi->image) }}" alt="" />
                                            </td>
                                            <td class=" "> {{ $transRegi->account_id }} </td>
                                            <td class=" "> {!! $transRegi->date !!} </td>
                                            <td class=" "> {!! $transRegi->dr !!} </td>
                                            <td class=" "> {!! $transRegi->cr !!} </td>
                                            <td class=" last">
                                                <a class="btn btn-primary" href="{{route( 'employee-profile',$transRegi->id )}}">
                                                    View
                                                </a>
                                                <a class="btn btn-primary" href="{{ route('employee-registration.edit', $transRegi->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('employee-registration.destroy',$transRegi->id)}}" style="display: inline">
