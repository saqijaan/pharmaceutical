            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('bank-register.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 col-sm-6 col-xs-12 col-md-offset-3">
                                        <a href="{{ url('/bank-register') }}" class="btn btn-danger">Cancel</a>
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $bnkRgstrs as $bnkRgstr )

                                        <tr class="even pointer">
                                            <td class=" "> {{ $bnkRgstr->id }}</td>
                                            <td class=" "> {{ $bnkRgstr->name }} </td>
                                            {{--<td class=" last">--}}
                                            {{--<a class="btn btn-primary" href="{{ route('account-head.edit', $bnkRgstr->id ) }}">--}}
                                            {{--<i class="fa fa-edit"></i>--}}
                                            {{--</a>--}}
                                            {{--<form method="post" enctype="multipart/form-data" action="{{route('account-head.destroy',$bnkRgstr->id)}}" style="display: inline">--}}
