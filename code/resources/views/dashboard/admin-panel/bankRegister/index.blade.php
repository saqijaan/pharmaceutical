            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('bank-register.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                                ...
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $bnkRgstrs as $bnkRgstr )
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" last">
                                                <a class="btn btn-primary" href="{{ route('bank-register.edit', $bnkRgstr->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('bank-register.destroy',$bnkRgstr->id)}}" style="display: inline">
