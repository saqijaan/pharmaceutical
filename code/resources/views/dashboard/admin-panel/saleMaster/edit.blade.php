            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('sale-master.update', [$saleMas->id] ) }}" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="discount" name="discount" value="{{ $saleMas->discount }}" onkeyup="cargoDis()" class="major-dis form-control">
                                    </div>
                                </div>
                                        ...
                                        <div class="img-main-div">
                                            <div class="form-group col-md-12 col-sm-12 col-xs-12">
                                                ...
                                                <div class="col-md-6 col-sm-6 col-xs-12">
                                                    ...
                                                    <img src="{{ asset('uploads/purMasterInvoiceImage/m/'.$saleMasImage->image) }}" alt="" width="60" />
                                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 col-sm-6 col-xs-12 col-md-offset-3">
                                        <a href="{{ url('/sale-master') }}" class="btn btn-danger">Cancel</a>
...
//        alert(quantity);
    ...
    $(document).ready(function() {
        ...
        $(".items").on('change', '.item', function(){
            ...
            $.ajax({
                url: "{{ url('/dashboard/getproductsaleprice') }}"+"/"+id,
