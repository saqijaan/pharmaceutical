            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('sale-master.store') }}" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <select class="form-control" id="cus_name" required="required" name="cus_name" required>
                                            <option value="">Choose option</option>
                                            @foreach( $cusRegis as $cusRegi )
                                                <option value="{{ $cusRegi->id }}"> {{ $cusRegi->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
...
//        alert(quantity);
    ...
    function getcostQuantity(e){
        var cost = $(".getcost-price"+e).val() ? $(".getcost-price"+e).val() : null,
                quantity = $(".quantity" + e).val() ? $(".quantity" + e).val() : 1,
                sub_total = $(".cost-quantity-total"+e).val() ? $(".cost-quantity-total"+e).val() : null,
                sub_dis = $(".sub-discount"+e).val() ? $(".sub-discount"+e).val() : 0;
//        alert(quantity);
