...
<div class="container" id="masterContent">
    ...
    <div class="row">
        <div class="col-md-4 col-sm-6 col-xs-12">
            ...
            <p style="border: 1px solid #ccc;padding: 5px 5px;"> {{ $saleMas->discount }}</p>
        </div>
        <div class="col-md-4 col-sm-6 col-xs-12">
    ...
    <a class="btn btn-success" href="{{action('SaleMasterController@downloadPDF', $saleMas->id)}}" target="_blank">Get PDF/Print </a>
</div>
