            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('doctor-regis.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8 col-sm-6 col-xs-12">
                                        <textarea type="text" id="name" required="required" name="address" class="form-control col-md-7 col-xs-12"></textarea>
                                    </div>
                                </div>
                                    ...
                                    @foreach( $docs as $doc )
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" last">
                                                ...
                                                <form method="post" enctype="multipart/form-data" action="{{route('doctor-regis.destroy',$doc->id)}}" style="display: inline">
