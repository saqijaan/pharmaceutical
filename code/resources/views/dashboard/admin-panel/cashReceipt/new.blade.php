            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('cash-receipt.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                {{--<div class="form-group col-md-3 col-sm-6 col-xs-12">--}}
                                    ...
                                    {{--</label>--}}
                                    {{--<div class="col-md-12 col-sm-12 col-xs-12">--}}
                                        {{--<input type="text" id="acnt_nbr" readonly required="required" name="acnt_nbr" class="form-control col-md-7 col-xs-12">--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 col-sm-6 col-xs-12 col-md-offset-3">
                                        <a href="{{ url('/dashboard/cash-receipt') }}" class="btn btn-danger">Cancel</a>
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $cshRcpts as $cshRcpt )
                                        <tr class="even pointer">
                                            <td class=" "> {{ $cshRcpt->id }}</td>
                                            <td class=" "> {{ $cshRcpt->date }} </td>
                                            <td class=" "> {{ $cshRcpt->acnt_nme  }}  </td>
                                            <td class=" "> {{ $cshRcpt->acnt_nbr  }}  </td>
                                            <td class=" last">
                                                <a class="btn btn-primary opnBtn" data-mdlid="{{$cshRcpt->id}}" type="button"> view </a>
                                                <a class="btn btn-primary" href="{{ route('schedule-regis.edit', $cshRcpt->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('schedule-regis.destroy',$cshRcpt->id)}}" style="display: inline">
