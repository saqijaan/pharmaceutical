            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('bank-payment.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $bnkPmnts as $bnkPmnt )
                                        <tr class="even pointer">
                                            <td class=" "> {{ $bnkPmnt->id }}</td>
                                            <td class=" "> {{ $bnkPmnt->date }} </td>
                                            <td class=" "> {{ $bnkPmnt->acnt_nme  }}  </td>
                                            <td class=" "> {{ $bnkPmnt->acnt_nbr  }}  </td>
                                            <td class=" last">
                                                <a class="btn btn-primary opnBtn" data-mdlid="{{$bnkPmnt->id}}" type="button"> view </a>
                                                <a class="btn btn-primary" href="{{ route('bank-payment.edit', $bnkPmnt->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('bank-payment.destroy',$bnkPmnt->id)}}" style="display: inline">
