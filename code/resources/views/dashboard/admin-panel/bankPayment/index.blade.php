            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('bank-payment.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                                ...
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $bnkPmnts as $bnkPmnt )
                                        <tr class="even pointer">
                                            ...
                                            <td class=" "> {{ $bnkPmnt->acntName  }}  </td>
                                            <td class=" "> {{ $bnkPmnt->bnkName  }}  </td>
                                            <td class=" last">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Bank Payment Invoice</h4>
                </div>
    ...
    <script type="text/javascript">
        $(".opnBtn").on('click',function(){
           var id = $(this).data("mdlid");
            $(".modal-body").load('{{url("/dashboard/bank-payment/view/")}}'+'/'+id, function(){
