        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Update Bank Payment post   </h2>
                             
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('bank-payment.update', [$bnkPmnts->id] ) }}" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="control-group">
                                                <div class="controls">
                                                    <div class="xdisplay_inputx form-group has-feedback" style="padding-left: 0px;">
                                                        <input type="text" class="form-control has-feedback-left" name="date" id="single_cal2" placeholder="First Name" value="{{date('m,d,y', strtotime($bnkPmnts->date))}}" aria-describedby="inputSuccess2Status2">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12" id="items">
                                        <select class="form-control" id="acnt_nme" required="required" name="acnt_nme">
                                            ...
                                            @foreach( $acnts as $acnt )
                                                <option value="{{ $acnt->id }}" {{ $acnt->id == $bnkPmnts->acnt_nme ? 'selected' : '' }}> {{ $acnt->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                {{--<div class="form-group col-md-3 col-sm-6 col-xs-12">--}}
                                    ...
                                    {{--</label>--}}
                                    {{--<div class="col-md-12 col-sm-12 col-xs-12">--}}
                                        {{--<input type="text" id="acnt_nbr" required="required" readonly value="{{$bnkPmnts->acnt_nbr}}" name="acnt_nbr" class="form-control col-md-7 col-xs-12">--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="amount" value="{{$bnkPmnts->amount}}" required="required" name="amount" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <select class="form-control" id="bnk_nme" required="required" name="bnk_nme">
                                            ...
                                            @foreach( $bnknames as $bnkname )
                                                <option value="{{ $bnkname->id }}" {{ ($bnkPmnts->bnk_nme == $bnkname->id) ? 'selected' : '' }}> {{ $bnkname->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12" id="items">
                                        <input type="text" id="chqe_no" required="required" value="{{$bnkPmnts->chqe_no}}" name="chqe_no" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <fieldset class="">
                                            <div class="control-group">
                                                <div class="controls">
                                                    <div class="xdisplay_inputx form-group has-feedback" style="padding-left: 0px;">
                                                        <input type="text"  value="{{ date('m,d,Y', strtotime($bnkPmnts->clrance_date))}}" class="form-control has-feedback-left" name="clrance_date" id="clearance" placeholder="First Name" aria-describedby="inputSuccess2Status2">
                                                        <span class="fa fa-calendar-o form-control-feedback left" style="left: 0;" aria-hidden="true"></span>
                                                        <span id="inputSuccess2Status2" class="sr-only">(success)</span>
                                                    </div>
                                                </div>
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <select class="form-control" id="bnk_rfrence" required="required" name="bnk_rfrence">
                                            <option>Choose option</option>
                                            @foreach( $bnknames as $bnkname )
                                                <option value="{{ $bnkname->id }}" {{ ($bnkPmnts->bnk_rfrence == $bnkname->id) ? 'selected' : '' }}> {{ $bnkname->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 col-sm-6 col-xs-12 col-md-offset-3">
                                        <a href="{{url('/dashboard/bank-payment')}}" class="btn btn-danger">Cancel</a>
