            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('sale-return.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                                    ...
                                    @foreach( $saleMas as $saleMa )
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" last">
                                                ...
                                                <a class="btn btn-primary" href="{{ route('sale-return.edit', $saleMa->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('sale-return.destroy',$saleMa->id)}}" style="display: inline">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Sale Return Invoice Detail</h4>
                </div>
...
@section('bottom_script')
    <script>
        $('.openBtn').on('click',function(){
            ...
            $('.modal-body').load('{{ url('/dashboard/sale-return/view') }}/'+id,function(){
