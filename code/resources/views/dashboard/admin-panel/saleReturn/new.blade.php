            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('sale-return.store') }}" class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="number" id="cus_invoice_no" name="cus_invoice_no" maxlength="15" class="form-control">
                                    </div>
                                </div>
