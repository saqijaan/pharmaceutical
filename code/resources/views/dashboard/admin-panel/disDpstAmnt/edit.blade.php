        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Update Distributer Deposit Amount   </h2>
                             
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('distributer-deposit-amount.update', [$disDpstAmnt->id] ) }}" data-parsley-validate class="form-horizontal form-label-left">
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="slip_name" value="{{ $disDpstAmnt->slip_name }}" name="slip_name" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="bank_name" value="{{ $disDpstAmnt->bank_name }}" name="bank_name" class="form-control">
                                    </div>
                                </div>
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="amount" value="{{ $disDpstAmnt->amount }}" name="amount" class="form-control">
                                    </div>
                                </div>
