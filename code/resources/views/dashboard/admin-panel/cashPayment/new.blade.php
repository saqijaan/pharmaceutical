            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('cash-payment.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    <label class="control-label col-md-12 col-sm-12 col-xs-12" for="acnt_nme" style="text-align:left;"> Cash Account <span class="required">*</span>
                                    </label>
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $cshPmnts as $cshPmnt )
                                        <tr class="even pointer">
                                            <td class=" "> {{ $cshPmnt->id }}</td>
                                            <td class=" "> {{ $cshPmnt->date }} </td>
                                            <td class=" "> {{ $cshPmnt->acnt_nme  }}  </td>
                                            <td class=" "> {{ $cshPmnt->acnt_nbr  }}  </td>
                                            <td class=" last">
                                                <a class="btn btn-primary opnBtn" data-mdlid="{{$cshPmnt->id}}" type="button"> view </a>
                                                <a class="btn btn-primary" href="{{ route('schedule-regis.edit', $cshPmnt->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('schedule-regis.destroy',$cshPmnt->id)}}" style="display: inline">
