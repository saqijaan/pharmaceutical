            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('cash-payment.update', [$cshPmnts->id] ) }}" data-parsley-validate class="form-horizontal form-label-left">
                                            ...
                                            <div class="control-group">
                                                <div class="controls">
                                                    <div class="xdisplay_inputx form-group has-feedback" style="padding-left: 0px;">
                                                        <input type="text" class="form-control has-feedback-left" name="date" id="single_cal2" placeholder="First Name" value="{{date('m,d,y', strtotime($cshPmnts->date))}}" aria-describedby="inputSuccess2Status2">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12" id="items">
                                        <select class="form-control" id="acnt_nme" required="required" name="acnt_nme">
                                            ...
                                            @foreach( $acnts as $acnt )
                                                <option value="{{ $acnt->id }}" {{ $acnt->id == $cshPmnts->acnt_nme ? 'selected' : '' }}> {{ $acnt->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    <label class="control-label col-md-12 col-sm-12 col-xs-12" for="pmnt_to" style="text-align:left;"> Payment To <span class="required">*</span>
                                    </label>
                                    <div class="col-md-12 col-sm-12 col-xs-12" id="items">
                                        <select class="form-control" id="pmnt_to" required="required" name="pmnt_to">
                                            <option>Choose option</option>
                                            @foreach( $acnts as $acnt )
                                                <option value="{{ $acnt->id }}" {{ $acnt->id == $cshPmnts->pmnt_to ? 'selected' : '' }}> {{ $acnt->name }}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
                                {{--<div class="form-group col-md-3 col-sm-6 col-xs-12">--}}
                                    ...
                                    {{--</label>--}}
                                    {{--<div class="col-md-12 col-sm-12 col-xs-12">--}}
                                        {{--<input type="text" id="acnt_nbr" required="required" readonly value="{{$cshPmnts->acnt_nbr}}" name="acnt_nbr" class="form-control col-md-7 col-xs-12">--}}
                                    {{--</div>--}}
                                {{--</div>--}}
                                <div class="form-group col-md-3 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="number" id="amount" value="{{$cshPmnts->amount}}" required="required" name="amount" class="form-control col-md-7 col-xs-12">
                                    </div>
                                </div>
                                <div class="clearfix"></div>
                                ...
                                <div class="form-group">
                                    <div class="col-md-8 col-sm-6 col-xs-12 col-md-offset-3">
                                        <a href="{{url('/dashboard/cash-payment')}}" class="btn btn-danger">Cancel</a>
