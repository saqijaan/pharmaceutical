                                ...
                                <table class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $jrnlVchrs as $jrnlVchr )
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" "> {{ date('m-d-Y', strtotime($jrnlVchr->date)) }} </td>
                                            <td class=" "> {!! $jrnlVchr->acntName !!} </td>
                                            <td class=" "> {!! $jrnlVchr->bnkName !!} </td>
                                            <td class=" last">
                                                <a type="button" data-mdlid="{{ $jrnlVchr->id }}" class="btn btn-primary openBtn">
                                                    View
                                                </a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Journal Voucher Invoice</h4>
                </div>
