            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        ...
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('account-head.store') }}" data-parsley-validate class="form-horizontal form-label-left">
                                @csrf
                                ...
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $accountHeads as $accountHead )
                                        ...
                                        <tr class="even pointer">
                                            <td class=" "> {{ $accountHead->id }}</td>
                                            <td class=" "> {{ $accountHead->name }} </td>
                                            <td class=" last">
                                                <a class="btn btn-primary" href="{{ route('account-head.edit', $accountHead->id ) }}">
                                                    <i class="fa fa-edit"></i>
                                                </a>
                                                <form method="post" enctype="multipart/form-data" action="{{route('account-head.destroy',$accountHead->id)}}" style="display: inline">
