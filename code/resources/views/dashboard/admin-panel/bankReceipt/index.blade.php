            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('bank-receipt.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                                ...
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $bnkRcpts as $bnkRcpt )
                                        <tr class="even pointer">
                                            ...
                                            <td class=" "> {{ $bnkRcpt->acntName  }}  </td>
                                            <td class=" "> {{ $bnkRcpt->bnkName  }}  </td>
                                            <td class=" last">
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title" id="myModalLabel">Bank Receipt Invoice</h4>
                </div>
