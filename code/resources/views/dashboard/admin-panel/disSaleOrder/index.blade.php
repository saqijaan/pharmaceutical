            ...
            <div class="page-title"><!-- page title and search bar column start -->
                ...
                <div class="title_left">
                    <div class="col-md-5 col-sm-12 col-xs-12 form-group top_search">
                        ...
                        <a href="{{route('distributer-sale-orders.create')}}" class="btn btn-lg btn-primary waves-effect"> Create New </a>
                        ...
                        <div class="x_content">
                            ...
                            <div class="table-responsive">
                                <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                    ...
                                    @foreach( $disSalesOdrs as $disSalesOdr )
                                        ...
                                        <tr class="even pointer">
                                            ...
                                            <td class=" last">
                                                ...
                                                <form method="post" enctype="multipart/form-data" action="{{route('distributer-sale-orders.destroy',$disSalesOdr->id)}}" style="display: inline">
