        ...
        <div class="">
            ...
            <div class="row">
                ...
                <div class="col-md-12 col-sm-12 col-xs-12">
                    <div class="x_panel">
                        <div class="x_title">
                            <h2> Update Distributer Sale Orders   </h2>
                             
                            <div class="clearfix"></div>
                        </div>
                        <div class="x_content">
                            <br />
                            <form id="demo-form2" method="post" enctype="multipart/form-data" action="{{ route('distributer-sale-orders.update', [$disSlsOdrs->id] ) }}" data-parsley-validate class="form-horizontal form-label-left">
                                    ...
                                    <div class="col-md-12 col-xs-12">
                                        <table id="datatable-buttons" class="table table-striped jambo_table bulk_action dt-responsive nowrap">
                                            ...
                                            <tr>
                                                ...
                                                @php $x = 1; @endphp
                                                @foreach( $disSlsOdrItems as $disSlsOdrItem )
                                                    <tr class="row-number" data-number="{{$x}}">
                                                        ...
                                                        <td>
                                                            <input type="number" name="quantity[{{$disSlsOdrItem->id}}]" placeholder="Quantity" value="{{$disSlsOdrItem->quantity}}" onKeyup="costQuantity( $(this).parent().parent('tr').data('number') )" class="quantity{{$x}} form-control col-md-12 col-xs-12">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="cost_price[{{$disSlsOdrItem->id}}]" placeholder="Cost Price" value="{{$disSlsOdrItem->cost_price}}"  onKeyup="costQuantity( $(this).parent().parent('tr').data('number') )" class="cost-price{{$x}} form-control col-md-12 col-xs-12">
                                                        </td>
                                                        <td>
                                                            <input type="number" name="total[{{$disSlsOdrItem->id}}]" placeholder="Total" readonly value="{{ $disSlsOdrItem->total }}" data-subtotal="{{$x}}" class="sub_total cost-quantity-total{{$x}} form-control col-md-12 col-xs-12" >
                                                        </td>
                                                        <td>

                                                            <button class="btn btn remove_field btn-danger" data-rowDel="{{ $x }}" id="{{ $disSlsOdrItem->id }}" type="button"><i class="fa fa-trash"></i></button>
                                                ...
                                                <tr>
                                                    <td colspan="7">
                                                        ...
                                                        <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                                            ...
                                                            <div class="col-md-12 col-sm-12 col-xs-12">
                                                                <input type="text" id="gross_total" name="gross_total" value="{{$disSlsOdrs->gross_total}}" readonly class=" gross_total form-control">
                                                            </div>
                                                        </div>
                                                    </td>
                                                </tr>
                                ...
                                <div class="form-group col-md-4 col-sm-6 col-xs-12">
                                    ...
                                    <div class="col-md-12 col-sm-12 col-xs-12">
                                        <input type="text" id="discount" name="discount" value="{{ $disSlsOdrs->discount }}" onkeyup="cargoDis()" class="major-dis form-control">
                                    </div>
                                </div>
